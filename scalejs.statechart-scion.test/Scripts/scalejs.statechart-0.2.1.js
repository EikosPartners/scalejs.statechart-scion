...
define('scalejs.statechart-scion/stateKinds',{
    BASIC: 0,
    COMPOSITE: 1,
    PARALLEL: 2,
    HISTORY: 3,
...
/*global define,setTimeout,clearTimeout*/
define('scalejs.statechart-scion/model',[
    'scalejs!core',
    './stateKinds'
], function (
    core,
...
/*global define,setTimeout,clearTimeout*/
define('scalejs.statechart-scion/transition',[
    'scalejs!core'
], function (
    core
) {
...
/*global define,setTimeout,clearTimeout*/
define('scalejs.statechart-scion/builder',[
    'scalejs!core'
], function (
    core
) {
...
/*global define,setTimeout,clearTimeout*/
define('scalejs.statechart-scion/factory',[
    'scalejs!core',
    './model',
    './state',
    './builder'
...
/*global define,setTimeout,clearTimeout*/
define('scalejs.statechart-scion/eventRaiser',[
    'scalejs!core'
], function (
    core
) {
...
/*global define,setTimeout,clearTimeout*/
define('scalejs.statechart-scion/runtime',[
    'scalejs!core',
    './eventRaiser'
], function (
    core,
...
/*global define,setTimeout,clearTimeout*/
define('scalejs.statechart-scion/transitionSelector',[
    'scalejs!core'
], function (
    core
) {
...
/*global define,setTimeout,clearTimeout*/
define('scalejs.statechart-scion/statechart',[
    'scalejs!core',
    './model',
    './factory',
    './runtime',
...
define('scalejs.statechart-scion',[
    'scalejs!core',
    './scalejs.statechart-scion/statechart',
    './scalejs.statechart-scion/builder'
], function (
    core,
    statechart,
    builder
